...
/**
 * Extract balanced JSON from LLM response text.
 * Handles cases where thinking blocks or preamble precede the JSON.
 * Scans forward from each `{` until finding valid balanced JSON.
 */
...
export async function complete(
  ...
  try {
    ...
    // Only return text blocks, skip thinking blocks
